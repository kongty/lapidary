...
if __name__ == "__main__":
    ...
    app_pool.add("app_0", AppConfig(pr_shape=(1, 1), pe=150, mem=15, input=1, output=1, runtime=100))
    app_pool.add("app_1", AppConfig(pr_shape=(1, 2), pe=150, mem=15, input=1, output=1, runtime=50))
